! function(a) {
    ...
    function f(b, c, d) {
        ...
        return b.hasAttribute("allownoenter") && (d.allownoenter = 0), a.extend(!0, c, d), c
    }
    ...
    function h(e, f, g) {
        function i(a, b, c) {
            ...
            var d, e, f, h = [],
                i = 0,
                j = p();
            ia = void 0 !== ga ? ga.maxLength : void 0, -1 === ia && (ia = void 0);
            do {
                if (a === !0 && n().validPositions[i]) {
                    var k = n().validPositions[i];
                ...
                i++
            } while ((void 0 === ia || ia > i) && (null !== e.fn || "" !== e.def) || b > i);
        ...
        function p(a, b, c) {
			...
			for (var g in f) {
				...
				//if (f[h].match.fn==null) {
				//	break;
				//}
            }
			var qq = -1 !== d && a - d > 1 || a > e ? d : e;
			return qq
        }
        ...
        function q(b, c, d, e) {
            if (e || g.insertMode && void 0 !== n().validPositions[b] && void 0 === d) {
                var f, h = a.extend(!0, {}, n().validPositions),
                    i = p();
                for (f = b; i >= f; f++) delete n().validPositions[f];
                ...
                for (f = j = b; i >= f; f++) {
                    var q = h[f];
                    if (void 0 !== q)
                        for (var r = j, s = -1; r < n().maskLength && (null == q.match.fn && l[f] && (l[f].match.optionalQuantifier === !0 || l[f].match.optionality === !0) || null != q.match.fn);) {
                            if (null === q.match.fn || !g.keepStatic && l[f] && (void 0 !== l[f + 1] && w(f + 1, l[f].locator.slice(), f).length > 1 || void 0 !== l[f].alternation) ? r++ : r = E(j), m === !1 && h[r] && h[r].match.def === q.match.def) {
                                n().validPositions[r] = a.extend(!0, {}, h[r]), n().validPositions[r].input = q.input, j = r, k = !0;
                                break
                            }
                            if (u(r, q.match.def)) {
                                var t = C(r, q.input, !0, !0);
                                if (k = t !== !1, j = t.caret || t.insert ? p() : r, m = !0, k) break
                            } else {
        ...
        function r(b, c, d, e) {
            ...
            for (o(!0), h = i + 1; h <= p();) {
                ...
                if (i > h && (h = i + 1), void 0 === n().validPositions[h] && D(h) || void 0 !== l) h++;
                else {
                    var m = s(h);
        ...
        function s(a, b, c) {
            var d = n().validPositions[a];
            if (void 0 === d)
                for (var e = w(a, b ? b.slice() : b, c), f = p(), h = n().validPositions[f] || w(0)[0], i = void 0 !== h.alternation ? h.locator[h.alternation].toString().split(",") : [], j = 0; j < e.length && (d = e[j], !(d.match && (g.greedy && d.match.optionalQuantifier !== !0 || (d.match.optionality === !1 || d.match.newBlockMarker === !1) && d.match.optionalQuantifier !== !0) && (void 0 === h.alternation || h.alternation !== d.alternation || void 0 !== d.locator[h.alternation] && B(d.locator[h.alternation].toString().split(","), i)))); j++);
            return d
        }

        function t(a) {
            return n().validPositions[a] ? n().validPositions[a].match : w(a)[0].match
        }
        ...
        function w(b, c, d) {
                ...
                function i(f, g, k) {
                    function p(b, c) {
                        ...
                        return d || a.each(c.matches, function(a, e) {
                            return (e.isQuantifier !== !0 || !(d = p(b, c.matches[a - 1]))) && void 0
                        }), d
                    }
                    ...
                    if (j > 1e4) throw "Inputmask: There is probably an error in your mask definition or in the code. Create an issue on github with an example of the mask you are using. " + n().mask;
            ...
            if (b > -1) {
                if (void 0 === c) {
                    for (var p, q = b - 1; void 0 === (p = n().validPositions[q] || n().tests[q]) && q > -1;) q--;
                    void 0 !== p && q > -1 && (k = f(p), o = k.join(""), j = q)
                }
                if (n().tests[b] && n().tests[b][0].cd === o) return g(n().tests[b]);
            ...
            return (0 === l.length || m) && l.push({
                ...
                locator: [],
                cd: o
            }), n().tests[b] = a.extend(!0, [], l), n().tests[b]
        }

        function x() {
            return void 0 === n()._buffer && (n()._buffer = i(!1, 1)), n()._buffer
        }

        function y(a) {
            if (void 0 === n().buffer || a === !0) {
                if (a === !0)
                    for (var b in n().tests) void 0 === n().validPositions[b] && delete n().tests[b];
                n().buffer = i(!0, p(), !0)
            }
            return n().buffer
        }
        ...
        function z(a, b, c) {
            var d;
            if (c = c, a === !0) o(), a = 0, b = c.length;
            else
                for (d = a; b > d; d++) delete n().validPositions[d], delete n().tests[d];
            for (d = a; b > d; d++) o(!0), c[d] !== g.skipOptionalPartCharacter && C(d, c[d], !0, !0)
        }
        ...
        function C(c, d, e, f) {
            function h(a) {
                return ka ? a.begin - a.end > 1 || a.begin - a.end === 1 && g.insertMode : a.end - a.begin > 1 || a.end - a.begin === 1 && g.insertMode
            }

            function i(b, d, e, f) {
                var i = !1;
                return a.each(w(b), function(j, k) {
                    for (var l = k.match, m = d ? 1 : 0, s = "", t = l.cardinality; t > m; t--) s += G(b - (t - 1));
                    if (d && (s += d), y(!0), i = null != l.fn ? l.fn.test(s, n(), b, e, g, h(c)) : (d === l.def || d === g.skipOptionalPartCharacter) && "" !== l.def && {
                        ...
                        if (void 0 !== i.remove && (a.isArray(i.remove) || (i.remove = [i.remove]), a.each(i.remove.sort(function(a, b) {
                            ...
                            if (e = !0, z(x === !0 ? x : x.start, x.end, w), void 0 === i.pos && void 0 === i.c) return i.pos = p(), !1;
                        ...
                        return (i === !0 || void 0 !== i.pos || void 0 !== i.c) && (j > 0 && o(!0), q(v, a.extend({}, k, {
                            input: A(u, l, v)
                        }), f, h(c)) || (i = !1), !1)
                    }
                }), i
            ...
            function j(b, c, d, e) {
                for (var f, h, i, j, k, l, m = a.extend(!0, {}, n().validPositions), q = a.extend(!0, {}, n().tests), r = p(); r >= 0 && (j = n().validPositions[r], !j || void 0 === j.alternation || (f = r, h = n().validPositions[f].alternation, s(f).locator[j.alternation] === j.locator[j.alternation])); r--);
                if (void 0 !== h) {
                    f = parseInt(f);
                    for (var t in n().validPositions)
                        if (t = parseInt(t), j = n().validPositions[t], t >= f && void 0 !== j.alternation) {
                            var u;
                            0 === f ? (u = [], a.each(n().tests[f], function(a, b) {
                                void 0 !== b.locator[h] && (u = u.concat(b.locator[h].toString().split(",")))
                            })) : u = n().validPositions[f].locator[h].toString().split(",");
                            ...
                            for (var x = 0; x < u.length; x++) {
                                var y = [],
                                    ...
                                    A = 0;
                                if (w < u[x]) {
                                    for (var B, D, E = t; E >= 0; E--)
                                        if (B = n().validPositions[E], void 0 !== B) {
                                            var F = v(E, u[x]);
                                            n().validPositions[E].match.def !== F.match.def && (n().validPositions[E].generatedInput !== !0 && y.push(n().validPositions[E].input), n().validPositions[E] = F, n().validPositions[E].input = I(E), null === n().validPositions[E].match.fn && A++, B = F), D = B.locator[h], B.locator[h] = parseInt(u[x]);
                                            break
                                        } if (w !== B.locator[h]) {
                                        for (k = t + 1; k < p(void 0, !0) + 1; k++) l = n().validPositions[k], l && null != l.match.fn ? y.push(l.input) : b > k && z++, delete n().validPositions[k], delete n().tests[k];
                                        for (o(!0), g.keepStatic = !g.keepStatic, i = !0; y.length > 0;) {
                                            var G = y.shift();
                                            if (G !== g.skipOptionalPartCharacter && !(i = C(p(void 0, !0) + 1, G, !1, e))) break
                                        }
                                        if (B.alternation = h, B.locator[h] = D, i) {
                                            var H = p(b) + 1;
                                            for (k = t + 1; k < p() + 1; k++) l = n().validPositions[k], (void 0 === l || null == l.match.fn) && b > k && A++;
                                            b += A - z, i = C(b > H ? H : b, c, d, e)
                                        }
                                        if (g.keepStatic = !g.keepStatic, i) return i;
                                        o(), n().validPositions = a.extend(!0, {}, m), n().tests = a.extend(!0, {}, q)
                                    }
                                }
                            }
                            break
            ...
            function k(b, c) {
                for (var d = n().validPositions[c], e = d.locator, f = e.length, g = b; c > g; g++)
            ...
            e = e === !0;
            var l = c;
            void 0 !== c.begin && (l = ka && !h(c) ? c.end : c.begin);
            for (var m = !1, t = a.extend(!0, {}, n().validPositions), u = l - 1; u > -1 && !n().validPositions[u]; u--);
            var x, F;
            for (u++; l > u; u++) void 0 === n().validPositions[u] && (g.jitMasking === !1 || g.jitMasking > u) && ((x = s(u)).match.def === g.radixPointDefinitionSymbol || !D(u, !0) || a.inArray(g.radixPoint, y()) < u && x.match.fn && x.match.fn.test(I(u), n(), u, !1, g)) && (F = p(u, !0) + 1, m = i(F, x.match.placeholder || (null == x.match.fn ? x.match.def : "" !== I(u) ? I(u) : y()[u]), !0, f), m !== !1 && (n().validPositions[m.pos || F].generatedInput = !0));
            if (h(c) && (R(void 0, b.keyCode.DELETE, c), l = n().p), l < n().maskLength && (m = i(l, d, e, f), (!e || f === !0) && m === !1)) {
                var H = n().validPositions[l];
                if (!H || null !== H.match.fn || H.match.def !== d && d !== g.skipOptionalPartCharacter) {
                    if ((g.insertMode || void 0 === n().validPositions[E(l)]) && !D(l, !0)) {
                        var J = s(l).match;
            ...
            return m === !1 && g.keepStatic && (m = j(l, d, e, f)), m === !0 && (m = {
                pos: l
            }), a.isFunction(g.postValidation) && m !== !1 && !e && f !== !0 && (m = !!g.postValidation(y(!0), m, g) && m), void 0 === m.pos && (m.pos = l), m === !1 && (o(!0), n().validPositions = a.extend(!0, {}, t)), m
        }

        function D(a, b) {
            var c;
            if (b ? (c = s(a).match, "" === c.def && (c = t(a))) : c = t(a), null != c.fn) return c.fn;
            if (b !== !0 && a > -1 && !g.keepStatic && void 0 === n().validPositions[a]) {
                var d = w(a);
                return d.length > 2
            }
            return !1
        ...
        function E(a, b) {
            var c = n().maskLength;
            if (a >= c) return c;
            for (var d = a; ++d < c && (b === !0 && (t(d).newBlockMarker !== !0 || !D(d)) || b !== !0 && !D(d) && (g.nojumps !== !0 || g.nojumpsThreshold > d)););
            return d
        }
        ...
        function F(a, b) {
            var c = a;
            if (0 >= c) return 0;
            for (; --c > 0 && (b === !0 && t(c).newBlockMarker !== !0 || b !== !0 && !D(c)););
            return c
        }
        ...
        function H(b, c, d, e, f) {
            ...
            b.inputmask._valueSet(c.join("")), void 0 === d || void 0 !== e && "blur" === e.type ? M(b, d) : m && "input" === e.type ? setTimeout(function() {
                M(b, d)
            }, 5) : M(b, d), f === !0 && (ma = !0, a(b).trigger("input"))
        }

        function I(a, b) {
            if (b = b || t(a), void 0 !== b.placeholder) return b.placeholder;
            if (null === b.fn) {
                if (a > -1 && !g.keepStatic && void 0 === n().validPositions[a]) {
                    var c, d = w(a),
                        e = [];
                    if (d.length > 2)
                        for (var f = 0; f < d.length; f++)
                            if (d[f].match.optionality !== !0 && d[f].match.optionalQuantifier !== !0 && (null === d[f].match.fn || void 0 === c || d[f].match.fn.test(c.match.def, n(), a, !0, g) !== !1) && (e.push(d[f]), null === d[f].match.fn && (c = d[f]), e.length > 1)) return g.placeholder.charAt(a % g.placeholder.length)
                }
                return b.def
            }
        ...
        function J(c, d, e, f) {
            ...
            if (o(), n().p = E(-1), !e)
                if (g.autoUnmask !== !0) {
                    var m = x().slice(0, E(-1)).join(""),
                        q = j.join("").match(new RegExp("^" + b.escapeRegex(m), "g"));
                    q && q.length > 0 && (j.splice(0, q.length * m.length), l = E(l))
                } else l = E(l);
            a.each(j, function(b, d) {
                if (void 0 !== d) {
                    ...
                    var j = p(void 0, !0),
                        m = n().validPositions[j],
                        q = s(j + 1, m ? m.locator.slice() : void 0, j);
                    if (!h() || e || g.autoUnmask) {
                        var r = e ? b : null == q.match.fn && q.match.optionality && j + 1 < n().p ? j + 1 : n().p;
                        i = T.call(c, f, !0, !1, e, r), l = r + 1, k = ""
                    } else i = T.call(c, f, !0, !1, !0, j + 1);
                    if (!e && a.isFunction(g.onBeforeWrite) && (i = g.onBeforeWrite(f, y(), i.forwardPosition, g), i && i.refreshFromBuffer)) {
                        ...
                        z(t === !0 ? t : t.start, t.end, i.buffer), o(!0), i.caret && (n().p = i.caret)
                    }
                }
            }), d && H(c, y(), document.activeElement === c ? E(p(0)) : void 0, new a.Event("checkval"))
        }
        ...
        function K(b) {
            ...
            var f = 0 === c.length ? "" : (ka ? c.reverse() : c).join("");
            if (a.isFunction(g.onUnMask)) {
                var h = (ka ? y().slice().reverse() : y()).join("");
        ...
        function M(a, b, c, d) {
            function e(a) {
                if (d !== !0 && ka && "number" == typeof a && (!g.greedy || "" !== g.placeholder)) {
                    var b = y().join("").length;
                    a = b - a
                }
                return a
        ...
        function O(a) {
            for (var b = N(), c = a.length - 1; c > b && !D(c); c--);
        ...
        function Q(b) {
                    ...
                    a.valHooks[b] = {
                        get: function(a) {
                            if (a.inputmask) {
                                ...
                                var b = c(a);
                                return -1 !== p(void 0, void 0, a.inputmask.maskset.validPositions) || g.nullable !== !0 ? b : ""
                            }
                            return c(a)
                        },
                        set: function(b, c) {
            ...
            function d() {
                return this.inputmask ? this.inputmask.opts.autoUnmask ? this.inputmask.unmaskedvalue() : -1 !== p() || g.nullable !== !0 ? document.activeElement === this && g.clearMaskOnLostFocus ? (ka ? O(y().slice()).reverse() : O(y().slice())).join("") : h.call(this) : "" : h.call(this)
            }
            ...
            if (!b.inputmask.__valueGet) {
                ...
                b.inputmask.__valueGet = h, b.inputmask._valueGet = function(a) {
                    return ka && a !== !0 ? h.call(this.el).split("").reverse().join("") : h.call(this.el)
                }, b.inputmask.__valueSet = i, b.inputmask._valueSet = function(a, b) {
                    i.call(this.el, null === a || void 0 === a ? "" : b !== !0 && ka ? a.split("").reverse().join("") : a)
                }, void 0 === h && (h = function() {
                    return this.value
                }, i = function(a) {
                    this.value = a
        ...
        function R(c, d, e, f) {
            function h() {
                if (g.keepStatic) {
                    o(!0);
                    var b, d = [],
                        e = a.extend(!0, {}, n().validPositions);
                    for (b = p(); b >= 0; b--) {
                        var f = n().validPositions[b];
                        if (f && (null != f.match.fn && d.push(f.input), delete n().validPositions[b], void 0 !== f.alternation && f.locator[f.alternation] === s(b).locator[f.alternation])) break
                    }
                    if (b > -1)
                        for (; d.length > 0;) {
                            n().p = E(p());
                            var h = new a.Event("keypress");
                            h.which = d.pop().charCodeAt(0), T.call(c, h, !0, !1, !1, n().p)
                        } else n().validPositions = a.extend(!0, {}, e)
                }
            }
            if ((g.numericInput || ka) && (d === b.keyCode.BACKSPACE ? d = b.keyCode.DELETE : d === b.keyCode.DELETE && (d = b.keyCode.BACKSPACE), ka)) {
                var i = e.end;
                e.end = e.begin, e.begin = i
            }
            d === b.keyCode.BACKSPACE && (e.end - e.begin < 1 || g.insertMode === !1) ? (e.begin = F(e.begin), void 0 === n().validPositions[e.begin] || n().validPositions[e.begin].input !== g.groupSeparator && n().validPositions[e.begin].input !== g.radixPoint || e.begin--) : d === b.keyCode.DELETE && e.begin === e.end && (e.end = D(e.end) ? e.end + 1 : E(e.end) + 1, void 0 === n().validPositions[e.begin] || n().validPositions[e.begin].input !== g.groupSeparator && n().validPositions[e.begin].input !== g.radixPoint || e.end++), r(e.begin, e.end, !1, f), f !== !0 && h();
            var j = p(e.begin);
            j < e.begin ? (-1 === j && o(), n().p = E(j)) : f !== !0 && (n().p = e.begin)
        }

        function S(d) {
            13 === d.keyCode && 0 == g.allownoenter && d.preventDefault();
            var e = this,
                f = a(e),
                h = d.keyCode,
                i = M(e);
            if (h === b.keyCode.BACKSPACE || h === b.keyCode.DELETE || l && h === b.keyCode.BACKSPACE_SAFARI || d.ctrlKey && h === b.keyCode.X && !c("cut")) d.preventDefault(), R(e, h, i), H(e, y(), n().p, d, fa !== y().join("")), e.inputmask._valueGet() === x().join("") ? f.trigger("cleared") : P(y()) === !0 && f.trigger("complete"), g.showTooltip && (e.title = g.tooltip || n().mask);
            else if (h === b.keyCode.END || h === b.keyCode.PAGE_DOWN) {
                d.preventDefault();
                var j = E(p());
                g.insertMode || j !== n().maskLength || d.shiftKey || j--, M(e, d.shiftKey ? i.begin : j, j, !0)
            } else h === b.keyCode.HOME && !d.shiftKey || h === b.keyCode.PAGE_UP ? (d.preventDefault(), M(e, 0, d.shiftKey ? i.begin : 0, !0)) : (g.undoOnEscape && h === b.keyCode.ESCAPE || 90 === h && d.ctrlKey) && d.altKey !== !0 ? (J(e, !0, !1, fa.split("")), f.trigger("click")) : h !== b.keyCode.INSERT || d.shiftKey || d.ctrlKey ? g.tabThrough === !0 && h === b.keyCode.TAB ? (d.shiftKey === !0 ? (null === t(i.begin).fn && (i.begin = E(i.begin)), i.end = F(i.begin, !0), i.begin = F(i.end, !0)) : (i.begin = E(i.begin, !0), i.end = E(i.begin, !0), i.end < n().maskLength && i.end--), i.begin < n().maskLength && (d.preventDefault(), M(e, i.begin, i.end))) : g.insertMode !== !1 || d.shiftKey || (h === b.keyCode.RIGHT ? setTimeout(function() {
                var a = M(e);
                M(e, a.begin)
            }, 0) : h === b.keyCode.LEFT && setTimeout(function() {
                var a = M(e);
                M(e, ka ? a.begin + 1 : a.begin - 1)
            }, 0)) : (g.insertMode = !g.insertMode, M(e, g.insertMode || i.begin !== n().maskLength ? i.begin : i.begin - 1));
            g.onKeyDown.call(this, d, y(), M(e).begin, g), na = -1 !== a.inArray(h, g.ignorables)
        }
        ...
        function T(c, d, e, f, h) {
            ...
            if (!(d === !0 || c.ctrlKey && c.altKey) && (c.ctrlKey || c.metaKey || na)) return k === b.keyCode.ENTER && fa !== y().join("") && (fa = y().join(""), setTimeout(function() {
                j.trigger("change")
            }, 0)), !0;
            if (k) {
                ...
                if (r !== !1) {
                    var s = r.pos;
                    if (o(!0), void 0 !== r.caret) l = r.caret;
                    else {
                        var t = n().validPositions;
                        l = !g.keepStatic && (void 0 !== t[s + 1] && w(s + 1, t[s].locator.slice(), s).length > 1 || void 0 !== t[s].alternation) ? s + 1 : E(s)
                    }
                    n().p = l
                }
                if (e !== !1) {
                    ...
                    if (setTimeout(function() {
                            g.onKeyValidation.call(u, k, r, g)
                        }, 0), n().writeOutBuffer && r !== !1) {
                        var v = y();
                        H(i, v, g.numericInput && void 0 === r.caret ? F(l) : l, c, d !== !0), d !== !0 && setTimeout(function() {
                            P(v) === !0 && j.trigger("complete")
                        }, 0)
                    }
                }
                if (m && j.is(":focus")) {
                ...
                if (g.showTooltip && (i.title = g.tooltip || n().mask), c.preventDefault(), d) return r.forwardPosition = l, r
            }
        }
        ...
        function U(b) {
            var c, d = this,
                ...
                i = M(d);
            ka && (c = i.end, i.end = i.begin, i.begin = c);
            var j = h.substr(0, i.begin),
                k = h.substr(i.end, h.length);
            j === (ka ? x().reverse() : x()).slice(0, i.begin).join("") && (j = ""), k === (ka ? x().reverse() : x()).slice(i.end).join("") && (k = ""), ka && (c = j, j = k, k = c), window.clipboardData && window.clipboardData.getData ? h = j + window.clipboardData.getData("Text") + k : e.clipboardData && e.clipboardData.getData && (h = j + e.clipboardData.getData("text/plain") + k);
            var l = h;
            if (a.isFunction(g.onBeforePaste)) {
                if (l = g.onBeforePaste(h, g), l === !1) return b.preventDefault();
                l || (l = h)
            }
            return J(d, !1, !1, ka ? l.split("").reverse() : l.toString().split("")), H(d, y(), E(p()), b, !0), P(y()) === !0 && f.trigger("complete"), b.preventDefault()
        }
        ...
        function V(c) {
            ...
            if (y().join("") !== e) {
                ...
                if (e = e.replace(new RegExp("(" + b.escapeRegex(x().join("")) + ")*"), ""), k) {
                    ...
                    if (1 === g.length) {
                        var h = new a.Event("keypress");
                        return h.which = g.charCodeAt(0), T.call(d, h, !0, !0, !1, n().validPositions[f.begin - 1] ? f.begin : f.begin - 1), !1
                    }
                }
                if (f.begin > e.length && (M(d, e.length), f = M(d)), y().length - e.length !== 1 || e.charAt(f.begin) === y()[f.begin] || e.charAt(f.begin + 1) === y()[f.begin] || D(f.begin)) {
                    for (var i = p() + 1, j = y().slice(i).join(""); null === e.match(b.escapeRegex(j) + "$");) j = j.slice(1);
                    e = e.replace(j, ""), e = e.split(""), J(d, !0, !1, e), P(y()) === !0 && a(d).trigger("complete")
        ...
        function W(b) {
            ...
            J(c, !0, !1, (a.isFunction(g.onBeforeMask) ? g.onBeforeMask(d, g) || d : d).split("")), fa = y().join(""),
                (g.clearMaskOnLostFocus || g.clearIncomplete) && c.inputmask._valueGet() === x().join("") && c.inputmask._valueSet("")
        }

        function X(a) {
            var b = this,
                c = b.inputmask._valueGet();
            g.showMaskOnFocus && (!g.showMaskOnHover || g.showMaskOnHover && "" === c) ? b.inputmask._valueGet() !== y().join("") && H(b, y(), E(p())) : oa === !1 && M(b, E(p())), g.positionCaretOnTab === !0 && setTimeout(function() {
                M(b, E(p()))
            }, 0), fa = y().join("")
        }
        ...
        function Y(a) {
            var b = this;
            if (oa = !1, g.clearMaskOnLostFocus && document.activeElement !== b) {
                var c = y().slice(),
                    d = b.inputmask._valueGet();
                d !== b.getAttribute("placeholder") && "" !== d && (-1 === p() && d === x().join("") ? c = [] : O(c), H(b, c))
            }
        }
            ...
            setTimeout(function() {
                if (document.activeElement === d) {
                    ...
                    if (b.begin === b.end) switch (g.positionCaretOnClick) {
                        ...
                        case "radixFocus":
                            if (c(b.begin)) {
                                M(d, g.numericInput ? E(a.inArray(g.radixPoint, y())) : a.inArray(g.radixPoint, y()));
                                break
                            }
                            default:
                                var e = b.begin,
                                    f = p(e, !0),
                                    h = E(f);
                                if (h > e) M(d, D(e) || D(e - 1) ? e : E(e));
                                else {
                                    var i = I(h);
                                    ("" !== i && y()[h] !== i || !D(h, !0) && t(h).def === i) && (h = E(h)), M(d, h)
                                }
                    }
                }
            }, 0)
        ...
        function _(c) {
            var d = this,
                ...
                j = ka ? y().slice(f.end, f.begin) : y().slice(f.begin, f.end);
            i.setData("text", ka ? j.reverse().join("") : j.join("")), document.execCommand && document.execCommand("copy"), R(d, b.keyCode.DELETE, f), H(d, y(), n().p, c, fa !== y().join("")), d.inputmask._valueGet() === x().join("") && e.trigger("cleared"), g.showTooltip && (d.title = g.tooltip || n().mask)
        }
        ...
        function aa(b) {
            ...
            if (d.inputmask) {
                var e = d.inputmask._valueGet(),
                    f = y().slice();
                fa !== f.join("") && setTimeout(function() {
                    c.trigger("change"), fa = f.join("")
                }, 0), "" !== e && (g.clearMaskOnLostFocus && (-1 === p() && e === x().join("") ? f = [] : O(f)), P(f) === !1 && (setTimeout(function() {
        ...
        function ba(a) {
            var b = this;
            oa = !0, document.activeElement !== b && g.showMaskOnHover && b.inputmask._valueGet() !== y().join("") && H(b, y())
        }

        function ca(a) {
            fa !== y().join("") && ha.trigger("change"), g.clearMaskOnLostFocus && -1 === p() && ga.inputmask._valueGet && ga.inputmask._valueGet() === x().join("") && ga.inputmask._valueSet(""), g.removeMaskOnSubmit && (ga.inputmask._valueSet(ga.inputmask.unmaskedvalue(), !0), setTimeout(function() {
                H(ga, y())
            }, 0))
        }
        ...
        function ea(b) {
            if (ga = b, ha = a(ga), g.showTooltip && (ga.title = g.tooltip || n().mask), ("rtl" === ga.dir || g.rightAlign) && (ga.style.textAlign = "right"), ("rtl" === ga.dir || g.numericInput) && (ga.dir = "ltr", ga.removeAttribute("dir"), ga.inputmask.isRTL = !0, ka = !0), pa.off(ga), Q(ga), d(ga, g) && (pa.on(ga, "submit", ca), pa.on(ga, "reset", da), pa.on(ga, "mouseenter", ba), pa.on(ga, "blur", aa), pa.on(ga, "focus", X), pa.on(ga, "mouseleave", Y), pa.on(ga, "click", Z), pa.on(ga, "dblclick", $), pa.on(ga, "paste", U), pa.on(ga, "dragdrop", U), pa.on(ga, "drop", U), pa.on(ga, "cut", _), pa.on(ga, "complete", g.oncomplete), pa.on(ga, "incomplete", g.onincomplete), pa.on(ga, "cleared", g.oncleared), g.inputEventOnly !== !0 && (pa.on(ga, "keydown", S), pa.on(ga, "keypress", T)), pa.on(ga, "input", V)), pa.on(ga, "setvalue", W), "" !== ga.inputmask._valueGet() || g.clearMaskOnLostFocus === !1 || document.activeElement === ga) {
                var c = a.isFunction(g.onBeforeMask) ? g.onBeforeMask(ga.inputmask._valueGet(), g) || ga.inputmask._valueGet() : ga.inputmask._valueGet();
                J(ga, !0, !1, c.split(""));
                var e = y().slice();
                fa = e.join(""), P(e) === !1 && g.clearIncomplete && o(), g.clearMaskOnLostFocus && document.activeElement !== ga && (-1 === p() ? e = [] : O(e)), H(ga, e), document.activeElement === ga && M(ga, E(p()))
            }
        }
        var fa, ga, ha, ia, ja, ka = !1,
            la = !1,
            ma = !1,
            na = !1,
            oa = !0,
                ...
                on: function(c, d, e) {
                    var f = function(c) {
                        if (void 0 === this.inputmask && "FORM" !== this.nodeName) {
                            ...
                            d ? new b(d).mask(this) : pa.off(this)
                        } else {
                            if ("setvalue" === c.type || !(this.disabled || this.readOnly && !("keydown" === c.type && c.ctrlKey && 67 === c.keyCode || g.tabThrough === !1 && c.keyCode === b.keyCode.TAB))) {
                                switch (c.type) {
                                    case "input":
                                        if (ma === !0) return ma = !1, c.preventDefault();
                                        break;
                                    case "keydown":
                                        la = !1, ma = !1;
                                        break;
                                    case "keypress":
                                        if (la === !0) return c.preventDefault();
                                        la = !0;
                                        break;
                                    case "click":
                                        if (k) {
        ...
        if (void 0 !== e) switch (e.action) {
            case "isComplete":
                return ga = e.el, P(y());
            case "unmaskedvalue":
                return ga = e.el, void 0 !== ga && void 0 !== ga.inputmask ? (f = ga.inputmask.maskset, g = ga.inputmask.opts, ka = ga.inputmask.isRTL) : (ja = e.value, g.numericInput && (ka = !0), ja = (a.isFunction(g.onBeforeMask) ? g.onBeforeMask(ja, g) || ja : ja).split(""), J(void 0, !1, !1, ka ? ja.reverse() : ja), a.isFunction(g.onBeforeWrite) && g.onBeforeWrite(void 0, y(), 0, g)), K(ga);
            case "mask":
                ga = e.el, f = ga.inputmask.maskset, g = ga.inputmask.opts, ka = ga.inputmask.isRTL, fa = y().join(""), ea(ga);
                break;
            case "format":
                return g.numericInput && (ka = !0), ja = (a.isFunction(g.onBeforeMask) ? g.onBeforeMask(e.value, g) || e.value : e.value).split(""), J(void 0, !1, !1, ka ? ja.reverse() : ja), a.isFunction(g.onBeforeWrite) && g.onBeforeWrite(void 0, y(), 0, g), e.metadata ? {
                    value: ka ? y().slice().reverse().join("") : y().join(""),
                    metadata: h({
                        action: "getmetadata"
                    }, f, g)
                } : ka ? y().slice().reverse().join("") : y().join("");
            case "isValid":
                g.numericInput && (ka = !0), e.value ? (ja = e.value.split(""), J(void 0, !1, !0, ka ? ja.reverse() : ja)) : e.value = y().join("");
                for (var qa = y(), ra = N(), sa = qa.length - 1; sa > ra && !D(sa); sa--);
                return qa.splice(ra, sa + 1 - ra), P(qa) && e.value === y().join("");
            case "getemptymask":
                return x().join("");
            case "remove":
                ga = e.el, ha = a(ga), f = ga.inputmask.maskset, g = ga.inputmask.opts, ga.inputmask._valueSet(K(ga)), pa.off(ga);
                var ta;
                Object.getOwnPropertyDescriptor && Object.getPrototypeOf ? (ta = Object.getOwnPropertyDescriptor(Object.getPrototypeOf(ga), "value"), ta && ga.inputmask.__valueGet && Object.defineProperty(ga, "value", {
                    get: ga.inputmask.__valueGet,
                    set: ga.inputmask.__valueSet,
                    configurable: !0
                })) : document.__lookupGetter__ && ga.__lookupGetter__("value") && ga.inputmask.__valueGet && (ga.__defineGetter__("value", ga.inputmask.__valueGet), ga.__defineSetter__("value", ga.inputmask.__valueSet)), ga.inputmask = void 0;
                break;
            case "getmetadata":
                if (a.isArray(f.metadata)) {
                    for (var ua, va = p(void 0, !0), wa = va; wa >= 0; wa--)
                        if (n().validPositions[wa] && void 0 !== n().validPositions[wa].alternation) {
                            ua = n().validPositions[wa].alternation;
                            break
                        } return void 0 !== ua ? f.metadata[n().validPositions[wa].locator[ua]] : []
                }
                return f.metadata
        }
    }
    ...
    return b.extendDefinitions({
        ...
        "dd/mm/yyyy": {
            ...
            isInYearRange: function(a, b, c) {
                ...
                return !isNaN(d) && (d >= b && c >= d) || !isNaN(e) && (e >= b && c >= e)
            },
