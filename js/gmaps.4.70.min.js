...
! function(e, t) {
    ...
    var t, o, n = function(e, t) {
        ...
        s = function(e, t) {
            var o, n, r, i, a;
            for (o = 0; o < e.length; o++) e[o] instanceof google.maps.LatLng || (e[o].length > 0 && "object" == typeof e[o][0] ? e[o] = s(e[o], t) : e[o] = (n = e[o], r = t, i = void 0, a = void 0, i = n[0], a = n[1], r && (i = n[1], a = n[0]), new google.maps.LatLng(i, a)));
            return e
        },
        a = function(e, t) {
            e = e.replace("#", "");
        ...
        l = function(e) {
            ...
            var t = document,
                o = function(e) {
                    ...
                    if ("string" == typeof e.el || "string" == typeof e.div ? g.indexOf("#") > -1 ? this.el = a(g, e.context) : this.el = function(e, t) {
                            var o = e.replace(".", "");
                    ...
                    for (1 != e.disableDefaultUI && (M = n(M, C)), x = n(M, e), r = 0; r < l.length; r++) delete x[l[r]];
                    for (r = 0; r < p.length; r++) delete x[p[r]];
                    this.map = new google.maps.Map(this.el, x), h && (this.markerClusterer = h.apply(this, [this.map]));
                    var O = function(e, t) {
                        var o = "",
                        ...
                        for (var r in n)
                            ...
                            var h = function(e) {
                                ...
                                u = h[0] + t.pixel.x - 15,
                                d = h[1] + t.pixel.y - 15;
                            l.style.left = u + "px", l.style.top = d + "px"
                        }
                    };
                    this.buildContextMenu = function(e, t) {
                        ...
                        for (o in e.options)
                            ...
                            } n.id = "gmaps_context_menu", n.style.display = "none", n.style.position = "absolute", n.style.minWidth = "100px", n.style.background = "white", n.style.listStyle = "none", n.style.padding = "8px", n.style.boxShadow = "2px 2px 6px #ccc", a("gmaps_context_menu") || t.body.appendChild(n);
    ...
    return l.prototype.createControl = function(e) {
        ...
        for (var n in e.id && (t.id = e.id), e.title && (t.title = e.title), e.classes && (t.className = e.classes), e.content && ("string" == typeof e.content ? t.innerHTML = e.content : e.content instanceof HTMLElement && t.appendChild(e.content)), e.position && (t.position = google.maps.ControlPosition[e.position.toUpperCase()]), e.events) ! function(t, o) {
        ...
        var t = this,
            ...
            a = n(s, e);
        delete a.lat, delete a.lng, delete a.fences, delete a.outside, delete a.inside;
        ...
        if (l.fences = r, e.infoWindow) {
            ...
            e.infoWindowOpen && l.infoWindow.open(t.map, l)
        }
        ...
        if (void 0 === e) {
            for (var o = 0; o < this.markers.length; o++) {
                (r = this.markers[o]).setMap(null), this.markerClusterer && this.markerClusterer.removeMarker(r), l.fire("marker_removed", r, this)
            }
            this.markers = t
        } else {
            for (o = 0; o < e.length; o++) {
                var n = this.markers.indexOf(e[o]);
                if (n > -1)(r = this.markers[n]).setMap(null), this.markerClusterer && this.markerClusterer.removeMarker(r), l.fire("marker_removed", r, this)
            }
        ...
        return t.setMap(this.map), null != e.auto_show && (o = e.auto_show), t.onAdd = function() {
            ...
            var n, r, i = this.getPanes(),
                s = ["contextmenu", "DOMMouseScroll", "dblclick", "mousedown"];
            i[e.layer].appendChild(o);
            for (var a = 0; a < s.length; a++) n = o, r = s[a], google.maps.event.addDomListener(n, r, function(e) {
        ...
        i.id = e.id, e.hasOwnProperty("clickable") && (i.clickable = e.clickable), e.hasOwnProperty("editable") && (i.editable = e.editable), e.hasOwnProperty("icons") && (i.icons = e.icons), e.hasOwnProperty("zIndex") && (i.zIndex = e.zIndex);
        for (var s = new google.maps.Polyline(i), a = ["click", "dblclick", "mousedown", "mousemove", "mouseout", "mouseover", "mouseup", "rightclick"], p = 0; p < a.length; p++) ! function(t, o) {
        ...
        e.bounds = t;
        for (var o = new google.maps.Rectangle(e), r = ["click", "dblclick", "mousedown", "mousemove", "mouseout", "mouseover", "mouseup", "rightclick"], i = 0; i < r.length; i++) ! function(t, o) {
            e[o] && google.maps.event.addListener(t, o, function(t) {
                e[o].apply(this, [t])
            })
        }(o, r[i]);
        ...
        e.hasOwnProperty("useGeoJSON") && (t = e.useGeoJSON), delete e.useGeoJSON, e = n({
            map: this.map
        }, e), 0 == t && (e.paths = [e.paths.slice(0)]), e.paths.length > 0 && e.paths[0].length > 0 && (e.paths = i(r(e.paths, s, t)));
        ...
        (e = n({
            ...
            path: !1,
            samples: 256
        }, e)).locations.length > 0 && e.locations[0].length > 0 && (e.locations = i(r([e.locations], s, !1)));
        var t = e.callback;
        delete e.callback;
    ...
    }, l.prototype.checkMarkerGeofence = function(e, t, t2) {
        if (e.fences)
            for (var o, n = 0; o = e.fences[n]; n++) {
                var r = e.getPosition();
                //this.checkGeofence(r.lat(), r.lng(), o) || t(e, o)
		        if (!this.checkGeofence(r.lat(), r.lng(), o)) {
					t(e, o);
				} else {
					t2(e, o);
				}
        ...
        if (i)
            for (var h, u, d = 0; o = i[d]; d++) {
                for (var g in h = [], o.size && "normal" !== o.size ? (h.push("size:" + o.size), delete o.size) : o.icon && (h.push("icon:" + encodeURI(o.icon)), delete o.icon), o.color && (h.push("color:" + o.color.replace("#", "0x")), delete o.color), o.label && (h.push("label:" + o.label[0].toUpperCase()), delete o.label), u = o.address ? o.address : o.lat + "," + o.lng, delete o.address, delete o.lat, delete o.lng, o) o.hasOwnProperty(g) && h.push(g + ":" + o[g]);
        ...
        return n.push("scale=" + x), r + (n = n.join("&"))
        ...
        if (-1 == l.custom_events.indexOf(e)) google.maps.event.trigger(t, e, Array.prototype.slice.apply(arguments).slice(2));
            ...
            for (var n = o.registered_events[e], r = 0; r < n.length; r++) i = n[r].handler, s = o, a = t, i.apply(s, [a]);
        var i, s, a
